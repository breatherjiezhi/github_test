...
import com.dhc.rad.modules.sys.web.LoginController;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
            ...
            if ("".equals(token.getCardID()) || token.getCardID() == null) {
                ...
                if (user != null) {
                    ...
                    if (!isOK) {
                        throw new AuthenticationException("msg:用户名或者密码错误.");
                    }
                ...
                //刷卡登录
                User user = getSystemService().getUserByCardID(token.getCardID());
                if (user != null) {
