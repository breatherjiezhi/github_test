...
public class SendMail {
    ...
    public static String myEmailAccount = "mmis@pbts-crrc.com";
    public static String myEmailPassword = "123.com";

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易126邮箱的 SMTP 服务器地址为: smtp.126.com
    public static String myEmailSMTPHost = "mail.pbts-crrc.com";

    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "18795898556@126.com";
