var addTabs = function (options) {
    ...
    last.contextPopup({
        ...
        items: [
            {
                label:'刷新缓存',icon:'static/assets/img/shopping-basket.png',action:function(){
                //last就是当前选中的元素
            ...
            {
                label:'关闭',icon:'static/assets/img/shopping-basket.png',action:function(){
                //last就是当前选中的元素
            ...
            {
                label:'全部关闭',icon:'static/assets/img/shopping-basket.png',action:function(){
                $("#tabs>ul>li").remove();
                $("#tabs>div>div").remove();
                //tabs.tabs("refresh");
            }
            ...
            {
                label:'除此之外全部关闭',icon:'static/assets/img/shopping-basket.png',action:function(){
                var closeText = last.children("a").text().trim();
                var nowText = $("#tabs").find("li[class='active']").children("a").text().trim();
            ...
            null,
            {
                label:'当前页右侧全部关闭',icon:'static/assets/img/shopping-basket.png',action:function(){
                var closeText = last.children("a").text().trim();
                var nowText = $("#tabs").find("li[class='active']").children("a").text().trim();
                if(closeText==nowText){
                    //当前页面
            ...
            {
                label:'当前页左侧全部关闭',icon:'static/assets/img/shopping-basket.png',action:function(){
                var closeText = last.children("a").text().trim();
                var nowText = $("#tabs").find("li[class='active']").children("a").text().trim();
                if(closeText==nowText){
                    //当前页面
