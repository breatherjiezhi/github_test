 ...
 */
package com.dhc.rad.modules.oa.web;
...
import com.dhc.rad.modules.oa.service.OaNotifyService;
...
public class OaNotifyController extends BaseController {
	...
	@ResponseBody
	public Map<String,Object> searchPage(OaNotify oaNotify,HttpServletRequest request, HttpServletResponse response) {
