        ...
        <form:form id="inputForm" modelAttribute="pzMenu" action="${ctx}/pzMenu/doSave"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <form:input path="menuName" htmlEscape="false" maxlength="64" class="input-xlarge " disabled="true"/>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <form:input path="menuDescription" htmlEscape="false" maxlength="64" class="input-xlarge required" disabled="true"/>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-6">
                    <form:select path="menuType" class="chosen-select form-control width-100"
                                 data-placeholder="点击选择..."  disabled="true">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <form:input path="menuCount" htmlEscape="false" maxlength="64" class="input-xlarge required" disabled="true"/>
