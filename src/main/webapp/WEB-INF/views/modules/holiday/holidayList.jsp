        ...
        <div class="widget-box widget-compact">
            ...
            <div class="widget-body">
                <div class="widget-main no-padding">
                    <form:form id="searchForm" modelAttribute="holiday" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-4 no-padding">
                                <div class="new-search clearfix">
                                    <label class=" col-xs-12 col-sm-4" for="holidayType" data-locale="holidayType">假期类型</label>
                                    <div class="col-xs-12 col-sm-8 no-padding">
                                        <input type="text" id="holidayType" class="ace width-100 newsearchInput"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 no-padding">
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        jQuery(function ($) {
            ...
            jQuery(grid_selector).jqGrid({
                ...
                url: '${ctx}/holiday/searchPage', //这是数据的请求地址
                height: 'auto',
                autowidth: true,
                jsonReader: {
                ...
                colNames: [
                    'id',
                    '<span data-locale="holidayType">假期类型</span>',
                    '<span data-locale="holidayDate">假期日期</span>'
                ],
                colModel: [
            ...
            jQuery(grid_selector).jqGrid('navGrid', pager_selector,
                ...
                caption:"<span data-locale='TempalteDownload'>模板下载</span>",
                ...
                caption:"<span data-locale='Import'>数据导入</span>",
            ...
            function upload() {
                $.post("${ctx}/holiday/uploadFileForm", function (data, textStatus, object) {
                    ...
                    $("#fileDivId").html(object.responseText).dialog({
                        ...
                        width: 472,
                        height: 350,
                        title: "<div class='widget-header widget-header-small widget-header-flat'><h4 class='smaller' style='line-height:2'><i class='ace-icon fa fa-users' id='flags'>&nbsp;<span data-locale='HolidayDocumentUpload'>节假日文件上传</span></h4></div>",
                        title_html: true,
                        buttons: [{
                            text: "保存",
            ...
            function _edita(id) {
                var id = id;
                var params = {"id": id};
                $.get("${ctx}/holiday/form", params, function (data, textStatus, object) {
            ...
            function doDelete() {
                ...
                $.msg_confirm.Init({
                    ...
                    'confirm_fn': function () {
                        ...
                        $.post("${ctx}/holiday/deleteByIds", params, function (result) {
                            if (result.messageStatus == "1") {
                                $.msg_show.Init({
                                    'msg': result.message,
                                    'type': 'success'
            ...
            $("#reset").click(function () {
                ...
                $(grid_selector).jqGrid('setGridParam', {
                    url: "${ctx}/holiday/searchPage",
                    mtype: "post",
                    postData: {'holidayType':'','holidayDate':''},
                    page: 1
                }).trigger("reloadGrid"); //重新载入
            });
