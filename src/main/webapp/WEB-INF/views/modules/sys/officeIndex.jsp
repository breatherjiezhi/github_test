...
<body>
	...
	<div id="content" class="row-fluid">
		<div id="left" class="accordion-group">
			<div class="accordion-heading">
		    	<a class="accordion-toggle" data-locale="organization">组织机构<i class="icon-refresh pull-right" onclick="refreshTree();"></i></a>
		    </div>
	...
	<script type="text/javascript">
		...
		function refreshTree(){
			var noCache=Date();
			$.getJSON("${ctx}/sys/office/treeData",{"noCache":noCache},function(data){
